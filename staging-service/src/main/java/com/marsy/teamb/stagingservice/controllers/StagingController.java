...
import com.marsy.teamb.stagingservice.logger.CustomLogger;
...
public class StagingController {
    ...
    private final static CustomLogger DISPLAY = new CustomLogger(StagingController.class);
    ...
    public ResponseEntity<String> shouldWeStage(@RequestBody FuelDataDTO fuelDto) {
        if (fuelDto.getFuelVolume() <= 8) {
            ...
            try {
                ...
                DISPLAY.logIgor("Could not call rocket service to stage rocket");
            }
        }
